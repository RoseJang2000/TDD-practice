...
function detectNetwork(cardNumber) {
   ...
   */
  if (
    (cardNumber.slice(0, 2) === '38' || cardNumber.slice(0, 2) === '39') &&
    ...
    cardNumber.slice(0, 2) / 1 >= 51 &&
    cardNumber.slice(0, 2) / 1 <= 55 &&
    ...
    (cardNumber.slice(0, 4) === '6011' ||
      ...
      (cardNumber.slice(0, 3) / 1 >= 644 && cardNumber.slice(0, 3) / 1 <= 649)) &&
