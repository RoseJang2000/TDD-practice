...
describe('Discover', function () {
  ...
  it('has a prefix of 6011 and a length of 16', function () {
    should.equal(detectNetwork('6011000011112222'), 'Discover');
  });
  it('has a prefix of 6011 and a length of 19', function () {
    should.equal(detectNetwork('6011000001111122222'), 'Discover');
  });
  it('has a prefix of 65 and a length of 16', function () {
    should.equal(detectNetwork('6500111122223333'), 'Discover');
  });
  it('has a prefix of 65 and a length of 19', function () {
    should.equal(detectNetwork('6500111122223333444'), 'Discover');
  });
  for (let i = 4; i <= 9; i++) {
    it(`has a prefix of 64${i + ''} and a length of 16`, function () {
      should.equal(detectNetwork(`64${i + ''}0111122223333`), 'Discover');
    });
    it(`has a prefix of 64${i + ''} and a length of 19`, function () {
      should.equal(detectNetwork(`64${i + ''}0111122223333444`), 'Discover');
    });
  }
});
